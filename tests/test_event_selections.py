...
arg200 = dict(datamc = 'data', levels = ('baseline_kinematics', 'loose'), cutflows = ('Signal', 'SingleEle'), hlt = False, pd = False, metnohf = False )
arg201 = dict(datamc = 'data', levels = ('baseline_kinematics', 'loose', 'final'), cutflows = ('Signal', 'SingleEle'), hlt = False, pd = False, metnohf = False )
arg202 = dict(datamc = 'data', levels = ('baseline_kinematics', 'loose'), cutflows = ( ), hlt = False, pd = False, metnohf = False )
arg203 = dict(datamc = 'data', levels = ('baseline_kinematics', 'loose', 'final'), cutflows = ( ), hlt = False, pd = False, metnohf = False )
