...
##__________________________________________________________________||
arg000 = dict(datamc = 'data', hlt = False, metnohf = False )
arg001 = dict(datamc = 'data', hlt = False, metnohf = True  )
arg002 = dict(datamc = 'data', hlt = True,  metnohf = False )
arg003 = dict(datamc = 'data', hlt = True,  metnohf = True  )
arg100 = dict(datamc = 'mc', hlt = False, metnohf = False )
arg101 = dict(datamc = 'mc', hlt = False, metnohf = True  )
arg102 = dict(datamc = 'mc', hlt = True,  metnohf = False )
arg103 = dict(datamc = 'mc', hlt = True,  metnohf = True  )
arg200 = dict(datamc = 'data', levels = ('baseline_kinematics', 'cutflows_loose'), cutflows = ('Signal', 'SingleEle'), hlt = False, metnohf = False )
arg201 = dict(datamc = 'data', levels = ('baseline_kinematics', 'cutflows_loose', 'final'), cutflows = ('Signal', 'SingleEle'), hlt = False, metnohf = False )
arg202 = dict(datamc = 'data', levels = ('baseline_kinematics', 'cutflows_loose'), cutflows = ( ), hlt = False, metnohf = False )
arg203 = dict(datamc = 'data', levels = ('baseline_kinematics', 'cutflows_loose', 'final'), cutflows = ( ), hlt = False, metnohf = False )
arg204 = dict(datamc = 'data', levels = ('final'), cutflows = ('Signal', 'SingleEle'), hlt = False, metnohf = False )
